...
require_once (THEMELIB . '/wpf/admin/admin-functions.php');		// Custom functions and plugins
require_once (THEMELIB . '/wpf/admin/admin-interface.php');		// Admin Interfaces (options,framework, seo)

/* These files build out the theme specific options and associated functions. */

// Options panel settings and custom settings
require_once (THEMELIB . '/wpf/admin/theme-options.php'); 
// Theme actions based on options settings		
require_once (THEMELIB . '/wpf/admin/theme-functions.php');
...
if (is_admin()) 
{
	wp_enqueue_style('custom_meta_css', TEMPLATEPATH . 'wpf/custom/meta.css');
}
...
(
    ...
    'title' => 'Artwork Info',
    'template' => TEMPLATEPATH . 'wpf/custom/artwork-meta.php',
    'context' => 'normal',
));
